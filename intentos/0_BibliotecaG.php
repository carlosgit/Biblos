            ...
            <table bgcolor="SkyBlue" width="220" border=2 cellpadding="4" cellspacing="5" >
                ...
                <tr>
                    <td>Contrase&ntilde;a
                        <input type=password name=contraseña maxlength=9 size=9 set="right">
                        *</td></tr>
                <tr>
                <td><u>Tipo de Usuario</u><br>
                        <input type="radio" name="accion" value="1" checked="checked" /> Usuario*
                        <br><input type="radio" name="accion" value="2" /> Administrador
                        *<br></td></tr>
